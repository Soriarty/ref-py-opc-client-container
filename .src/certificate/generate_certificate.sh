...
openssl req -x509 -newkey rsa:2048 -keyout app_private_key.pem -out app_cert.pem -days 355 -nodes -addext "subjectAltName = URI:urn:example.org:FreeOpcUa:python-opcua"
openssl x509 -outform der -in app_cert.pem -out app_cert.der